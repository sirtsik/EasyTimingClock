package com.sirje.laube.easytimingclock;
...
public class StartDialogFragment extends DialogFragment {
    ...
    LinearLayout startTimePickerContainer;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        startTimePickerContainer = getView().findViewById(R.id.start_time_picker_container);
        ...
        if(!isIntervalStart) {
            intervalPickerContainer.setVisibility(View.GONE);
            intervalPickerLabel.setVisibility(View.GONE);
